 ...
 */
case class LociMap[T] private(@transient private val map: SortedMap[ReferenceContig, Contig[T]])
...
object LociMap {
  ...
  def apply[T](): LociMap[T] = LociMap(TreeMap[ReferenceContig, Contig[T]]())

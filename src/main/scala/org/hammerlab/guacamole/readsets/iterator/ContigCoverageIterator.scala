...
import org.hammerlab.genomics.reference.{ ContigIterator, Interval, Locus, WindowSize }
 ...
 */
case class ContigCoverageIterator(halfWindowSize: WindowSize,
   ...
   */
  private var lastStart: Locus = Locus(0)

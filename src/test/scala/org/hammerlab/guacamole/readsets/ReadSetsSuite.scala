...
//    implicit def intToSeqInt(i: Int): List[Int] = List(i)
    implicit def t1ToE(t: (Int, Iterable[Int], Iterable[Int])): ExpectedReadIdxs3 = (List(t._1), t._2, t._3)
    implicit def t3ToE(t: (Iterable[Int], Iterable[Int], Int)): ExpectedReadIdxs3 = (t._1, t._2, List(t._3))
